...
const ProductDetails = () => {
    ...
    return product && (
        <div className="max-w-6xl w-full px-6 mt-29">
            ...
            <div className="flex flex-col md:flex-row gap-16 mt-4 items-start md:items-center">
                <div className="flex gap-3">

                    {/* Thumbnails */}
                    <div className="flex flex-col gap-3 w-20 md:w-24 h-75 md:h-112.5">
                        {product.image.map((image, index) => (
                            <div key={index} onClick={() => setThumbnail(image)} className="flex-1 border border-gray-500/30 rounded overflow-hidden cursor-pointer" >
                     ...
                     {/* Main image */}
                    <div className="border border-gray-500/30 w-75 md:w-112.5 aspect-square rounded overflow-hidden">
