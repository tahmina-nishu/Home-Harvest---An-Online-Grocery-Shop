...
const Navbar = () => {
    ...
    return (
    <nav className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-100 shadow-md bg-white relative transition-all">
                ...
                {!user ? 
                    ...
                    (
                        <div className='relative group'>
                            ...
                            <ul className='hidden group-hover:block absolute top-10 right-0 bg-white shadow border border-gray-200 p-2.5 w-32 rounded-md text-sm z-40'>
